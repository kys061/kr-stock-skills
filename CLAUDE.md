...
#### 5-3. KRX Open API 상태
- `krx_openapi_provider.py` 생성 완료 → `kr_client.py` Tier 0 통합 완료
- **개별 서비스 이용 신청 필요**: openapi.krx.co.kr → 마이페이지 → 각 서비스별 "API 이용신청"
- 승인 완료 시 401 → 200 전환되며 자동으로 KRX Open API 우선 사용
