...
| 컴포넌트 | 가중치 | 입력 소스 |
|----------|:------:|-----------|
| 시장 구조 (market_structure) | 18% | kr-market-breadth, kr-uptrend-analyzer |
| 분배 리스크 (distribution_risk) | 18% | kr-market-top-detector |
| 바닥 확인 (bottom_confirmation) | 12% | kr-ftd-detector |
| 거시 정합 (macro_alignment) | 18% | kr-macro-regime |
| 테마 품질 (theme_quality) | 12% | kr-theme-detector |
| 셋업 가용 (setup_availability) | 10% | kr-vcp-screener, kr-canslim-screener |
| 시그널 수렴 (signal_convergence) | 12% | 전체 스킬 |
